...
public class SearchControllerApi {
    ...
    public okhttp3.Call searchCall(String query, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/_search/all";
    ...
    private okhttp3.Call searchValidateBeforeCall(String query, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchCall(query, _callback);
        return localVarCall;
     ...
     */
    public SearchResultDTO search(String query) throws ApiException {
        ApiResponse<SearchResultDTO> localVarResp = searchWithHttpInfo(query);
     ...
     * 
     * @param query  (required)
     * @return ApiResponse&lt;SearchResultDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SearchResultDTO> searchWithHttpInfo(String query) throws ApiException {
        okhttp3.Call localVarCall = searchValidateBeforeCall(query, null);
        Type localVarReturnType = new TypeToken<SearchResultDTO>(){}.getType();
     ...
     */
    public okhttp3.Call searchAsync(String query, final ApiCallback<SearchResultDTO> _callback) throws ApiException {
