...
public class MailsControllerApi {
    ...
    /**
     * Build call for getSendToDevUsingGET
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSendToDevUsingGETCall(String body, String subject, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/mails/send-to-dev";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSendToDevUsingGETValidateBeforeCall(String body, String subject, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling getSendToDevUsingGET(Async)");
        }
        // verify the required parameter 'subject' is set
        if (subject == null) {
            throw new ApiException("Missing the required parameter 'subject' when calling getSendToDevUsingGET(Async)");
        }
        
        com.squareup.okhttp.Call call = getSendToDevUsingGETCall(body, subject, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void getSendToDevUsingGET(String body, String subject) throws ApiException {
        getSendToDevUsingGETWithHttpInfo(body, subject);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> getSendToDevUsingGETWithHttpInfo(String body, String subject) throws ApiException {
        com.squareup.okhttp.Call call = getSendToDevUsingGETValidateBeforeCall(body, subject, null, null);
        return apiClient.execute(call);
    }

    /**
     * getSendToDev (asynchronously)
     * 
     * @param body body (required)
     * @param subject subject (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSendToDevUsingGETAsync(String body, String subject, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSendToDevUsingGETValidateBeforeCall(body, subject, progressListener, progressRequestListener);
