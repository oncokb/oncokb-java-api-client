...
public class SearchApiTest {
    ...
    public void searchGetUsingGETTest() throws ApiException {
        ...
        String hgvs = null;
        String fields = null;
        IndicatorQueryResp response = api.searchGetUsingGET(id, hugoSymbol, entrezGeneId, variant, variantType, svType, consequence, proteinStart, proteinEnd, tumorType, levels, highestLevelOnly, queryType, evidenceType, hgvs, fields);
