...
public class SearchApi {
    ...
    private okhttp3.Call searchGetUsingGETValidateBeforeCall(String id, String referenceGenome, String hugoSymbol, Integer entrezGeneId, String variant, String variantType, String svType, String consequence, Integer proteinStart, Integer proteinEnd, String tumorType, String levels, Boolean highestLevelOnly, String evidenceType, String hgvs, String fields, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchGetUsingGETCall(id, referenceGenome, hugoSymbol, entrezGeneId, variant, variantType, svType, consequence, proteinStart, proteinEnd, tumorType, levels, highestLevelOnly, evidenceType, hgvs, fields, _callback);
        return localVarCall;
    ...
    public IndicatorQueryResp searchGetUsingGET(String id, String referenceGenome, String hugoSymbol, Integer entrezGeneId, String variant, String variantType, String svType, String consequence, Integer proteinStart, Integer proteinEnd, String tumorType, String levels, Boolean highestLevelOnly, String evidenceType, String hgvs, String fields) throws ApiException {
        ApiResponse<IndicatorQueryResp> localVarResp = searchGetUsingGETWithHttpInfo(id, referenceGenome, hugoSymbol, entrezGeneId, variant, variantType, svType, consequence, proteinStart, proteinEnd, tumorType, levels, highestLevelOnly, evidenceType, hgvs, fields);
    ...
    public ApiResponse<IndicatorQueryResp> searchGetUsingGETWithHttpInfo(String id, String referenceGenome, String hugoSymbol, Integer entrezGeneId, String variant, String variantType, String svType, String consequence, Integer proteinStart, Integer proteinEnd, String tumorType, String levels, Boolean highestLevelOnly, String evidenceType, String hgvs, String fields) throws ApiException {
        okhttp3.Call localVarCall = searchGetUsingGETValidateBeforeCall(id, referenceGenome, hugoSymbol, entrezGeneId, variant, variantType, svType, consequence, proteinStart, proteinEnd, tumorType, levels, highestLevelOnly, evidenceType, hgvs, fields, null);
    ...
    public okhttp3.Call searchGetUsingGETAsync(String id, String referenceGenome, String hugoSymbol, Integer entrezGeneId, String variant, String variantType, String svType, String consequence, Integer proteinStart, Integer proteinEnd, String tumorType, String levels, Boolean highestLevelOnly, String evidenceType, String hgvs, String fields, final ApiCallback<IndicatorQueryResp> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchGetUsingGETValidateBeforeCall(id, referenceGenome, hugoSymbol, entrezGeneId, variant, variantType, svType, consequence, proteinStart, proteinEnd, tumorType, levels, highestLevelOnly, evidenceType, hgvs, fields, _callback);
        Type localVarReturnType = new TypeToken<IndicatorQueryResp>(){}.getType();
