...
public class CancerGenesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesGetUsingGETCall(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call utilsAllCuratedGenesGetUsingGETValidateBeforeCall(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = utilsAllCuratedGenesGetUsingGETCall(version, includeEvidence, progressListener, progressRequestListener);
        return call;
    ...
    public List<CuratedGene> utilsAllCuratedGenesGetUsingGET(String version, Boolean includeEvidence) throws ApiException {
        ApiResponse<List<CuratedGene>> resp = utilsAllCuratedGenesGetUsingGETWithHttpInfo(version, includeEvidence);
        return resp.getData();
    }
    ...
    public ApiResponse<List<CuratedGene>> utilsAllCuratedGenesGetUsingGETWithHttpInfo(String version, Boolean includeEvidence) throws ApiException {
        com.squareup.okhttp.Call call = utilsAllCuratedGenesGetUsingGETValidateBeforeCall(version, includeEvidence, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesGetUsingGETAsync(String version, Boolean includeEvidence, final ApiCallback<List<CuratedGene>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = utilsAllCuratedGenesGetUsingGETValidateBeforeCall(version, includeEvidence, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<CuratedGene>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesTxtGetUsingGETCall(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call utilsAllCuratedGenesTxtGetUsingGETValidateBeforeCall(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = utilsAllCuratedGenesTxtGetUsingGETCall(version, includeEvidence, progressListener, progressRequestListener);
        return call;
    ...
    public String utilsAllCuratedGenesTxtGetUsingGET(String version, Boolean includeEvidence) throws ApiException {
        ApiResponse<String> resp = utilsAllCuratedGenesTxtGetUsingGETWithHttpInfo(version, includeEvidence);
        return resp.getData();
    }
    ...
    public ApiResponse<String> utilsAllCuratedGenesTxtGetUsingGETWithHttpInfo(String version, Boolean includeEvidence) throws ApiException {
        com.squareup.okhttp.Call call = utilsAllCuratedGenesTxtGetUsingGETValidateBeforeCall(version, includeEvidence, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesTxtGetUsingGETAsync(String version, Boolean includeEvidence, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = utilsAllCuratedGenesTxtGetUsingGETValidateBeforeCall(version, includeEvidence, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
