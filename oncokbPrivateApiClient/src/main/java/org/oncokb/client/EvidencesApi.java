...
public class EvidencesApi {
     ...
     */
    public com.squareup.okhttp.Call evidencesLookupGetUsingGETCall(Integer entrezGeneId, String hugoSymbol, String variant, String tumorType, String consequence, String proteinStart, String proteinEnd, Boolean highestLevelOnly, String levelOfEvidence, String evidenceTypes, String fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call evidencesLookupGetUsingGETValidateBeforeCall(Integer entrezGeneId, String hugoSymbol, String variant, String tumorType, String consequence, String proteinStart, String proteinEnd, Boolean highestLevelOnly, String levelOfEvidence, String evidenceTypes, String fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = evidencesLookupGetUsingGETCall(entrezGeneId, hugoSymbol, variant, tumorType, consequence, proteinStart, proteinEnd, highestLevelOnly, levelOfEvidence, evidenceTypes, fields, progressListener, progressRequestListener);
        return call;
    ...
    public List<Evidence> evidencesLookupGetUsingGET(Integer entrezGeneId, String hugoSymbol, String variant, String tumorType, String consequence, String proteinStart, String proteinEnd, Boolean highestLevelOnly, String levelOfEvidence, String evidenceTypes, String fields) throws ApiException {
        ApiResponse<List<Evidence>> resp = evidencesLookupGetUsingGETWithHttpInfo(entrezGeneId, hugoSymbol, variant, tumorType, consequence, proteinStart, proteinEnd, highestLevelOnly, levelOfEvidence, evidenceTypes, fields);
        return resp.getData();
    }
    ...
    public ApiResponse<List<Evidence>> evidencesLookupGetUsingGETWithHttpInfo(Integer entrezGeneId, String hugoSymbol, String variant, String tumorType, String consequence, String proteinStart, String proteinEnd, Boolean highestLevelOnly, String levelOfEvidence, String evidenceTypes, String fields) throws ApiException {
        com.squareup.okhttp.Call call = evidencesLookupGetUsingGETValidateBeforeCall(entrezGeneId, hugoSymbol, variant, tumorType, consequence, proteinStart, proteinEnd, highestLevelOnly, levelOfEvidence, evidenceTypes, fields, null, null);
     ...
     */
    public com.squareup.okhttp.Call evidencesLookupGetUsingGETAsync(Integer entrezGeneId, String hugoSymbol, String variant, String tumorType, String consequence, String proteinStart, String proteinEnd, Boolean highestLevelOnly, String levelOfEvidence, String evidenceTypes, String fields, final ApiCallback<List<Evidence>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = evidencesLookupGetUsingGETValidateBeforeCall(entrezGeneId, hugoSymbol, variant, tumorType, consequence, proteinStart, proteinEnd, highestLevelOnly, levelOfEvidence, evidenceTypes, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Evidence>>(){}.getType();
