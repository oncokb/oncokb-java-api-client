...
public class VariantsApi {
    ...
    private com.squareup.okhttp.Call variantsLookupGetUsingGETValidateBeforeCall(Integer entrezGeneId, String hugoSymbol, String variant, String variantType, String consequence, Integer proteinStart, Integer proteinEnd, String hgvs, String referenceGenome, String fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = variantsLookupGetUsingGETCall(entrezGeneId, hugoSymbol, variant, variantType, consequence, proteinStart, proteinEnd, hgvs, referenceGenome, fields, progressListener, progressRequestListener);
        return call;
    ...
    public List<Alteration> variantsLookupGetUsingGET(Integer entrezGeneId, String hugoSymbol, String variant, String variantType, String consequence, Integer proteinStart, Integer proteinEnd, String hgvs, String referenceGenome, String fields) throws ApiException {
        ApiResponse<List<Alteration>> resp = variantsLookupGetUsingGETWithHttpInfo(entrezGeneId, hugoSymbol, variant, variantType, consequence, proteinStart, proteinEnd, hgvs, referenceGenome, fields);
        return resp.getData();
    }
    ...
    public ApiResponse<List<Alteration>> variantsLookupGetUsingGETWithHttpInfo(Integer entrezGeneId, String hugoSymbol, String variant, String variantType, String consequence, Integer proteinStart, Integer proteinEnd, String hgvs, String referenceGenome, String fields) throws ApiException {
        com.squareup.okhttp.Call call = variantsLookupGetUsingGETValidateBeforeCall(entrezGeneId, hugoSymbol, variant, variantType, consequence, proteinStart, proteinEnd, hgvs, referenceGenome, fields, null, null);
        Type localVarReturnType = new TypeToken<List<Alteration>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call variantsLookupGetUsingGETAsync(Integer entrezGeneId, String hugoSymbol, String variant, String variantType, String consequence, Integer proteinStart, Integer proteinEnd, String hgvs, String referenceGenome, String fields, final ApiCallback<List<Alteration>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = variantsLookupGetUsingGETValidateBeforeCall(entrezGeneId, hugoSymbol, variant, variantType, consequence, proteinStart, proteinEnd, hgvs, referenceGenome, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Alteration>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
