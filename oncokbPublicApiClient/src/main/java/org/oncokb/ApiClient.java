...
public class ApiClient {
    ...
    private String basePath = "http://oncokb-core:8888/api/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.2.1-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://oncokb-core:8888/api/v1
