...
public class CancerGenesApi {
     ...
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesGetUsingGET1Call(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("includeEvidence", includeEvidence));
    ...
    private com.squareup.okhttp.Call utilsAllCuratedGenesGetUsingGET1ValidateBeforeCall(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = utilsAllCuratedGenesGetUsingGET1Call(version, includeEvidence, progressListener, progressRequestListener);
        return call;
    ...
    public List<CuratedGene> utilsAllCuratedGenesGetUsingGET1(String version, Boolean includeEvidence) throws ApiException {
        ApiResponse<List<CuratedGene>> resp = utilsAllCuratedGenesGetUsingGET1WithHttpInfo(version, includeEvidence);
        return resp.getData();
    }
    ...
    public ApiResponse<List<CuratedGene>> utilsAllCuratedGenesGetUsingGET1WithHttpInfo(String version, Boolean includeEvidence) throws ApiException {
        com.squareup.okhttp.Call call = utilsAllCuratedGenesGetUsingGET1ValidateBeforeCall(version, includeEvidence, null, null);
     ...
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesGetUsingGET1Async(String version, Boolean includeEvidence, final ApiCallback<List<CuratedGene>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = utilsAllCuratedGenesGetUsingGET1ValidateBeforeCall(version, includeEvidence, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<CuratedGene>>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesTxtGetUsingGET1Call(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call utilsAllCuratedGenesTxtGetUsingGET1ValidateBeforeCall(String version, Boolean includeEvidence, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = utilsAllCuratedGenesTxtGetUsingGET1Call(version, includeEvidence, progressListener, progressRequestListener);
        return call;
    ...
    public String utilsAllCuratedGenesTxtGetUsingGET1(String version, Boolean includeEvidence) throws ApiException {
        ApiResponse<String> resp = utilsAllCuratedGenesTxtGetUsingGET1WithHttpInfo(version, includeEvidence);
        return resp.getData();
    }
    ...
    public ApiResponse<String> utilsAllCuratedGenesTxtGetUsingGET1WithHttpInfo(String version, Boolean includeEvidence) throws ApiException {
        com.squareup.okhttp.Call call = utilsAllCuratedGenesTxtGetUsingGET1ValidateBeforeCall(version, includeEvidence, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call utilsAllCuratedGenesTxtGetUsingGET1Async(String version, Boolean includeEvidence, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = utilsAllCuratedGenesTxtGetUsingGET1ValidateBeforeCall(version, includeEvidence, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
