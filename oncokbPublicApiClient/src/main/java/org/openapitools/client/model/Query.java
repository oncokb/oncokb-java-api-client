...
public class Query {
  ...
  public enum AlterationTypeEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      AlterationTypeEnum.fromValue(value);
    }
  }
  ...
  public static final String SERIALIZED_NAME_CANONICAL_TRANSCRIPT = "canonicalTranscript";
  @SerializedName(SERIALIZED_NAME_CANONICAL_TRANSCRIPT)
  @javax.annotation.Nullable
  ...
  public static final String SERIALIZED_NAME_HGVS_INFO = "hgvsInfo";
  @SerializedName(SERIALIZED_NAME_HGVS_INFO)
  @javax.annotation.Nullable
  ...
  public Query alteration(@javax.annotation.Nullable String alteration) {
  ...
  public Query alterationType(@javax.annotation.Nullable AlterationTypeEnum alterationType) {
  ...
  public void setAlterationType(@javax.annotation.Nullable AlterationTypeEnum alterationType) {
    this.alterationType = alterationType;
  }


  public Query canonicalTranscript(@javax.annotation.Nullable String canonicalTranscript) {
  ...
  public void setCanonicalTranscript(@javax.annotation.Nullable String canonicalTranscript) {
    this.canonicalTranscript = canonicalTranscript;
  }


  public Query consequence(@javax.annotation.Nullable String consequence) {
  ...
  public Query entrezGeneId(@javax.annotation.Nullable Integer entrezGeneId) {
  ...
  public Query hgvs(@javax.annotation.Nullable String hgvs) {
    this.hgvs = hgvs;
    return this;
  }
  ...
  public void setHgvs(@javax.annotation.Nullable String hgvs) {
    this.hgvs = hgvs;
  }


  public Query hgvsInfo(@javax.annotation.Nullable String hgvsInfo) {
  ...
  public void setHgvsInfo(@javax.annotation.Nullable String hgvsInfo) {
    this.hgvsInfo = hgvsInfo;
  }


  public Query hugoSymbol(@javax.annotation.Nullable String hugoSymbol) {
  ...
  public Query id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Query proteinEnd(@javax.annotation.Nullable Integer proteinEnd) {
  ...
  public Query proteinStart(@javax.annotation.Nullable Integer proteinStart) {
  ...
  public Query referenceGenome(@javax.annotation.Nullable ReferenceGenomeEnum referenceGenome) {
  ...
  public Query svType(@javax.annotation.Nullable SvTypeEnum svType) {
    this.svType = svType;
    return this;
  }
  ...
  public void setSvType(@javax.annotation.Nullable SvTypeEnum svType) {
    this.svType = svType;
  }


  public Query tumorType(@javax.annotation.Nullable String tumorType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alteration, query.alteration) &&
        ...
        Objects.equals(this.canonicalTranscript, query.canonicalTranscript) &&
        ...
        Objects.equals(this.hgvsInfo, query.hgvsInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alteration, alterationType, canonicalTranscript, consequence, entrezGeneId, hgvs, hgvsInfo, hugoSymbol, id, proteinEnd, proteinStart, referenceGenome, svType, tumorType);
  }
  ...
  public String toString() {
    ...
    sb.append("    canonicalTranscript: ").append(toIndentedString(canonicalTranscript)).append("\n");
    ...
    sb.append("    hgvsInfo: ").append(toIndentedString(hgvsInfo)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `alterationType`
      if (jsonObj.get("alterationType") != null && !jsonObj.get("alterationType").isJsonNull()) {
        AlterationTypeEnum.validateJsonElement(jsonObj.get("alterationType"));
      }
      if ((jsonObj.get("canonicalTranscript") != null && !jsonObj.get("canonicalTranscript").isJsonNull()) && !jsonObj.get("canonicalTranscript").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `canonicalTranscript` to be a primitive type in the JSON string but got `%s`", jsonObj.get("canonicalTranscript").toString()));
      }
      ...
      if ((jsonObj.get("hgvsInfo") != null && !jsonObj.get("hgvsInfo").isJsonNull()) && !jsonObj.get("hgvsInfo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hgvsInfo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hgvsInfo").toString()));
      }
