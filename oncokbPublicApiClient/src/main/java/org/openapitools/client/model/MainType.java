...
public class MainType {
  ...
  public MainType id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public MainType name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MainType tumorForm(@javax.annotation.Nullable TumorFormEnum tumorForm) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to MainType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MainType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MainType is not found in the empty JSON string", MainType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MainType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MainType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MainType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MainType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MainType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MainType.class));

       return (TypeAdapter<T>) new TypeAdapter<MainType>() {
           @Override
           public void write(JsonWriter out, MainType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MainType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MainType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MainType
   * @throws IOException if the JSON string is invalid with respect to MainType
   */
  public static MainType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MainType.class);
  }

  /**
   * Convert an instance of MainType to an JSON string
   *
   * @return JSON string
   */
