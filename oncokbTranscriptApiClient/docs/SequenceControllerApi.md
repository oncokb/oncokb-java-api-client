...
------------- | ------------- | -------------
[**findCanonicalProteinSequenceUsingGET**](SequenceControllerApi.md#findCanonicalProteinSequenceUsingGET) | **GET** /api/find-canonical-protein-sequences | findCanonicalProteinSequence
[**findCanonicalProteinSequencesUsingPOST**](SequenceControllerApi.md#findCanonicalProteinSequencesUsingPOST) | **POST** /api/find-canonical-protein-sequences | findCanonicalProteinSequences
...
<a name="findCanonicalProteinSequenceUsingGET"></a>
# **findCanonicalProteinSequenceUsingGET**
> CanonicalProteinSequenceVM findCanonicalProteinSequenceUsingGET(referenceGenome, entrezGeneId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CanonicalProteinSequenceVM result = apiInstance.findCanonicalProteinSequenceUsingGET(referenceGenome, entrezGeneId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SequenceControllerApi#findCanonicalProteinSequenceUsingGET");
...
[**CanonicalProteinSequenceVM**](CanonicalProteinSequenceVM.md)
...
<a name="findCanonicalProteinSequencesUsingPOST"></a>
# **findCanonicalProteinSequencesUsingPOST**
> List&lt;CanonicalProteinSequenceVM&gt; findCanonicalProteinSequencesUsingPOST(referenceGenome, requestBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<CanonicalProteinSequenceVM> result = apiInstance.findCanonicalProteinSequencesUsingPOST(referenceGenome, requestBody);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SequenceControllerApi#findCanonicalProteinSequencesUsingPOST");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**List&lt;CanonicalProteinSequenceVM&gt;**](CanonicalProteinSequenceVM.md)
